namespace MediatR.Internal
{
        ...
        where TRequest : IRequest<TResponse>
    {
            ...
            ServiceFactory serviceFactory)
        {
            ...
            Task<TResponse> Execute() => handlerInstance.Handle((TRequest) request, cancellationToken);

            return serviceFactory
                .GetInstances<IPipelineBehavior<TRequest, TResponse>>()
                .Reverse()
                .Aggregate((RequestHandlerDelegate<TResponse>) Execute, (next, pipeline) => () => pipeline.Handle((TRequest)request, cancellationToken, next, handlerInstance))();
        }
    }
}
